...
export const SolutionsSection = ({ showFiltersAndBlogCards = true }: { showFiltersAndBlogCards?: boolean }) => {
        ...
        <div className="flex items-start gap-8 relative">
          {solutionCards.map((card) => (
            <div
              ...
              style={{ transition: 'background 0.3s, color 0.3s', border: 'none' }}
              onMouseEnter={e => (e.currentTarget.style.background = 'rgba(0,13,27,1)', e.currentTarget.style.color = 'white')}
              onMouseLeave={e => (e.currentTarget.style.background = 'white', e.currentTarget.style.color = '')}
            >
              <Card
                key={card.id}
                className="flex flex-col items-start gap-8 p-0 relative h-full bg-transparent text-inherit shadow-none"
              >
                <CardContent className="p-0 flex flex-col h-full border-none">
                  {card.id === "connect" ? (
                    <svg width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative w-[60px] h-[60px] transition-colors duration-300 group-hover:text-white group-hover:[&_*]:fill-white">
                      <path d="M38.2316 22.0765C41.1339 22.0765 43.4867 19.7329 43.4867 16.842C43.4867 13.951 41.1339 11.6074 38.2316 11.6074C35.3293 11.6074 32.9766 13.951 32.9766 16.842C32.9766 19.7329 35.3293 22.0765 38.2316 22.0765Z" fill="#000D1B"/>
                      <path d="M23.3823 22.0749C26.2844 22.0749 28.6374 19.731 28.6374 16.8403C28.6374 13.9497 26.2844 11.6074 23.3823 11.6074C20.4803 11.6074 18.1289 13.9513 18.1289 16.842C18.1289 19.7327 20.4819 22.0765 23.384 22.0765L23.3823 22.0749Z" fill="#000D1B"/>
                      <path d="M34.1208 45.5346C34.1208 47.7962 35.9621 49.6303 38.2326 49.6303C40.503 49.6303 42.3443 47.7962 42.3443 45.5346V28.926H44.848L38.2326 23.2285L31.6172 28.926H34.1208V45.5346Z" fill="#000D1B"/>
                      <path d="M19.2693 45.5346C19.2693 47.7962 21.1106 49.6303 23.381 49.6303C25.6515 49.6303 27.4928 47.7962 27.4928 45.5346V28.926H29.9964L23.381 23.2285L16.7656 28.926H19.2693V45.5346Z" fill="#000D1B"/>
                    </svg>
                  ) : card.id === "explore" ? (
                    <svg width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative w-[60px] h-[60px] transition-colors duration-300 group-hover:text-white group-hover:[&_*]:fill-white">
                      <path d="M13.6973 45.7715C13.6973 48.0332 15.546 49.8673 17.8257 49.8673C20.1054 49.8673 21.9541 48.0332 21.9541 45.7715V29.1626H24.4678L17.8257 23.4648L11.1836 29.1626H13.6973V45.7715Z" fill="#000D1B"/>
                      <path d="M25.7422 45.7719C25.7422 48.0336 27.5909 49.8677 29.8706 49.8677C32.1504 49.8677 33.9991 48.0336 33.9991 45.7719V23.4986H36.5127L29.8706 17.8008L23.2285 23.4986H25.7422V45.7719Z" fill="#000D1B"/>
                      <path d="M34.8984 17.565H37.4121V45.7714C37.4121 48.0331 39.2608 49.8672 41.5405 49.8672C43.8203 49.8672 45.669 48.0331 45.669 45.7714V17.565H48.1827L41.5416 11.8672L34.8995 17.565H34.8984Z" fill="#000D1B"/>
                    </svg>
                  ) : (
                    card.id === "deploy" ? (
                      <svg width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative w-[60px] h-[60px] transition-colors duration-300 group-hover:text-white group-hover:[&_*]:fill-white">
                        <path d="M19.828 27.5222C21.7643 29.4585 24.9023 29.4585 26.8386 27.5222C28.7749 25.5859 28.7749 22.4479 26.8386 20.5116L20.3294 14.0024L22.4624 11.8672L11.9465 12.6312L11.1836 23.1471L13.3177 21.013L19.8269 27.5222H19.828Z" fill="#000D1B"/>
                        <path d="M40.0942 47.7884L37.9601 49.9225L48.476 49.1596L49.2389 38.6437L47.1048 40.7778L40.5956 34.2686C38.6593 32.3323 35.5213 32.3323 33.585 34.2686C31.6487 36.2049 31.6487 39.3429 33.585 41.2792L40.0942 47.7884Z" fill="#000D1B"/>
                        <path d="M33.585 27.5222C35.5213 29.4585 38.6593 29.4585 40.5956 27.5222L47.1048 21.013L49.2389 23.1471L48.476 12.6312L37.9601 11.8672L40.0942 14.0013L33.585 20.5105C31.6487 22.4467 31.6487 25.5848 33.585 27.5211V27.5222Z" fill="#000D1B"/>
                        <path d="M20.3283 47.7884L26.8375 41.2792C28.7737 39.3429 28.7737 36.2049 26.8375 34.2686C24.9012 32.3323 21.7632 32.3323 19.8269 34.2686L13.3177 40.7778L11.1836 38.6437L11.9465 49.1596L22.4624 49.9225L20.3283 47.7884Z" fill="#000D1B"/>
                      </svg>
                    ) : (
                      <img
