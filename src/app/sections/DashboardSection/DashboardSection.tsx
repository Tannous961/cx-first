        ...
        {articles.map((article, idx) => (
          ...
          >
            ...
            <div className="absolute inset-0 z-20 transition-all duration-300 group-hover:opacity-100 opacity-0">
              <div className={`w-full h-full object-cover ${article.bgImage} bg-cover bg-center`} />
            ...
            <div className="relative z-30 flex flex-col h-full" style={{paddingTop: '14.5rem', paddingLeft: '1.5rem', paddingRight: '1.5rem', paddingBottom: '4.5rem'}}>
              ...
              <h3 className="font-bold text-2xl mb-3 mt-0 leading-tight transition-colors duration-300 text-[#000D1B] group-hover:text-white">{article.title}</h3>
              <p className="text-base opacity-80 mb-4 transition-colors duration-300 text-[#000D1B] group-hover:text-white">{article.description}</p>
