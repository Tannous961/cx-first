  ...
  const infoBlocks = [
    {
      ...
      title: "Qualimetrie",
      description:
        "Qualimetrie est une entreprise spécialisée dans l'analyse et l'optimisation de l'expérience client.",
    },
    {
      icon: "/icon-increase.svg",
      title: "CX first",
      description:
        "CX First est une initiative de Qualimetrie, dédiée à l'amélioration de l'expérience client à travers des analyses approfondies et des solutions innovantes.",
    },
  ];

  return (
    <section className="w-full flex flex-col items-center justify-center px-[30px] py-20 relative bg-white overflow-hidden">
      <div className="flex flex-row items-start justify-center gap-16 w-full max-w-[1240px] mx-auto">
        <div className="absolute w-[994px] h-[1106px] -top-0.5 left-[-215px]" style={{backgroundImage: 'url(/line left.svg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
          <img
        ...
        <div className="flex flex-col items-start gap-8 relative w-1/2 min-w-[320px] max-w-[600px]">
          <div className="flex items-center justify-center gap-8 relative self-stretch w-full">
            <div className="flex flex-col w-[324px] items-center justify-center gap-2.5">
              <svg width="325" height="115" viewBox="0 0 325 115" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[255.83px] h-[102px]">
                <g clipPath="url(#clip0_407_9144)">
                  <path d="M59.7576 27.3324H72.1353V14.6074H59.7576C46.0683 14.6074 34.9316 25.5997 34.9316 39.1117C34.9316 52.6236 46.0683 63.6159 59.7576 63.6159H72.1353V50.891H59.7576C53.1772 50.891 47.8237 45.6068 47.8237 39.1117C47.8237 32.6165 53.1772 27.3324 59.7576 27.3324Z" fill="#000D1B"/>
                  <path d="M159.716 26.671V14.6074H125.355V63.6159H138.18V46.1016H154.058V34.4345H138.113V26.671H159.716Z" fill="#000D1B"/>
                  <path d="M118.349 14.6074H103.278L94.3471 27.8979L85.416 14.6074H70.3457L86.8117 39.1117L70.3457 63.6159H85.416L94.3471 50.3254L103.278 63.6159H118.349L101.882 39.1117L118.349 14.6074Z" fill="#000D1B"/>
                  <path d="M174.914 14.6074H162.021V63.6159H174.914V14.6074Z" fill="#000D1B"/>
                  <path d="M252.656 14.6074V26.7374H265.333V63.6159H278.091V26.7374H290.764V14.6074H252.656Z" fill="#000D1B"/>
                  <path d="M214.18 52.49C209.498 52.49 205.689 49.9893 203.549 46.105C210.898 44.1944 215.567 38.2763 215.567 30.6849C215.567 26.1473 213.84 22.0432 210.705 19.1295C207.567 16.2134 203.128 14.6074 198.207 14.6074H177.217V63.6159H189.974V47.309C191.439 51.9997 194.347 56.2151 198.267 59.2928C202.697 62.7701 208.036 64.6074 213.706 64.6074H218.579V52.5084L214.18 52.49H214.18ZM197.135 35.6245H190.042V25.8122H197.135C200.688 25.8122 202.809 27.6585 202.809 30.7512C202.809 33.8439 200.635 35.6245 197.135 35.6245Z" fill="#000D1B"/>
                  <path d="M233.099 26.7693L250.644 26.7354V14.6074H235.716C230.882 14.6074 226.41 16.0089 223.125 18.5545C220.657 20.4662 218.987 22.8876 218.18 25.6825C217.809 26.9668 217.619 28.3303 217.619 29.7597C217.619 37.2793 222.91 42.9515 231.433 44.5634L237.922 45.7519C239.186 45.9908 242.126 46.8237 242.126 49.3888C242.126 51.0755 240.742 52.4431 239.034 52.4461L220.616 52.4795V64.6074H236.386C243.4 64.6074 247.742 61.9172 250.151 59.6609C251.996 57.9322 253.371 55.8171 254.181 53.5328C254.729 51.9867 255.018 50.3628 255.018 48.7284C255.018 41.0413 249.417 35.2419 240.405 33.5951L234.038 32.4041C230.875 31.8305 230.276 30.9567 230.276 29.5438C230.285 28.0106 231.546 26.7718 233.099 26.7693Z" fill="#000D1B"/>
                </g>
                <defs>
                  <clipPath id="clip0_407_9144">
                    <rect width="255.833" height="50" fill="white" transform="translate(34.9316 14.6074)"/>
                  </clipPath>
                </defs>
              </svg>
            </div>
          ...
          <p className="self-stretch [font-family:'DM_Sans',Helvetica] font-normal text-grey text-lg tracking-[0] leading-[18px]">
            <span className="font-[number:var(--body-bold-medium-font-weight)] leading-[var(--body-bold-medium-line-height)] font-body-bold-medium [font-style:var(--body-bold-medium-font-style)] tracking-[var(--body-bold-medium-letter-spacing)] text-[length:var(--body-bold-medium-font-size)]">
              CX First est intégrée au&nbsp;&nbsp;groupe Qualimetrie
            </span>

            <span className="leading-6">
              , qui possède 15 ans d&#39;expertise. En mettant
              l&#39;accent&nbsp;&nbsp;sur la satisfaction et les attentes des
              clients,{" "}
            </span>

            <span className="font-[number:var(--body-bold-medium-font-weight)] leading-[var(--body-bold-medium-line-height)] font-body-bold-medium [font-style:var(--body-bold-medium-font-style)] tracking-[var(--body-bold-medium-letter-spacing)] text-[length:var(--body-bold-medium-font-size)]">
              CX First utilise les&nbsp;&nbsp;méthodes de Qualimetrie
            </span>

            <span className="leading-6">
              {" "}
              pour mesurer et améliorer la qualité des&nbsp;&nbsp;services.{" "}
            </span>
          </p>
        ...
        <Card className="flex-1 overflow-hidden shadow-[0px_8px_10px_-6px_#0000001a,0px_20px_25px_-5px_#0000001a] rounded-xl w-[480px] max-w-[480px]">
          <CardContent className="p-0">
            <div className="relative w-full h-[320px] overflow-hidden">
              <img
                className="absolute w-[480px] h-[320px] top-0 left-0 object-cover"
